...
import (
	...
	"github.com/S-ign/bookings/internal/forms"
	...
	"github.com/S-ign/bookings/internal/repository/dbrepo"
)
...
func (m *Repository) SearchReservation(w http.ResponseWriter, r *http.Request) {
	render.Template(w, r, "search-reservation.page.tmpl", &models.TemplateData{})
}

// PostSearchReservation page
func (m *Repository) PostSearchReservation(w http.ResponseWriter, r *http.Request) {
...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	_, err = m.DB.GetAllAvailableRooms(startDate, endDate)
	if err != nil {
		helpers.ServerError(w, err)
	}
	...
	form.MinLength(3, "first_name", "last_name", "email")
	form.MinLength(10, "phone")
	form.IsEmail("email")
...
// SearchAvailabilityJSON returns JSON
...
func (m *Repository) ReservationSummary(w http.ResponseWriter, r *http.Request) {
	...
	if !ok {
		...
		m.App.Session.Put(r.Context(), "error", "must book a reservation first")
